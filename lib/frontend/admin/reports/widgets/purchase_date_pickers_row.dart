...
class PurchaseDatePickersRow extends StatelessWidget {
  const PurchaseDatePickersRow({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [Expanded(child: fromField), const SizedBox(width: 16), Expanded(child: toField)]);
  }
}
